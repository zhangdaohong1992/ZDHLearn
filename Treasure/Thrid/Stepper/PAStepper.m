...
- (void)setInitialValues
{
	...
	_continuous = YES;
	_minimumValue = 1;
	_maximumValue = 10000000.;
	_stepValue = 1;
	_wraps = NO;
	_autorepeat = YES;
	_autorepeatInterval = 0.1;
    ...
    [decrementButton setBackgroundImage:[UIImage imageNamed:@"left"] forState:UIControlStateNormal];
	[decrementButton setTintColor:_tintColor];
	[decrementButton setTitle:@"-" forState:UIControlStateNormal];
    [decrementButton setTitleColor:UIColorFromRGB(0x263238) forState:UIControlStateNormal];
    ...
    NSLog(@"decrementButton%@", NSStringFromCGRect(decrementButton.frame));
	...
	// background image
	backgroundImageView = [[UIImageView alloc] initWithFrame:CGRectMake(decrementButton.right, 0.0, self.width - 50, 29.0)];
    NSLog(@"backgroundImageView%@", NSStringFromCGRect(backgroundImageView.frame));
    normalStateImage = [UIImage imageNamed:@"middle"];
	[backgroundImageView setImage:normalStateImage];
	[self addSubview:backgroundImageView];
	
	// label
	label = [[UILabel alloc] initWithFrame:CGRectMake(2, 0, backgroundImageView.width, 29)];
    ...
    _textField = [[ADNoActionTextField alloc] initWithFrame:CGRectMake(decrementButton.right, 0.0, self.width - 50, 29.0)];
    ...
    NSLog(@"_textField%@", NSStringFromCGRect(_textField.frame));
    ...
    [_textField addTarget:self action:@selector(didEndEditingTextField) forControlEvents: UIControlEventEditingDidEndOnExit];
	...
	// init right button
	incrementButton = [[UIButton alloc] initWithFrame:CGRectMake(backgroundImageView.right, 0.0, 25.0, 29.0)];
    [incrementButton setBackgroundImage:[UIImage imageNamed:@"right"] forState:UIControlStateNormal];
	[incrementButton setTintColor:_tintColor];
	[incrementButton setTitle:@"+" forState:UIControlStateNormal];
    [incrementButton setTitleColor:UIColorFromRGB(0x263238) forState:UIControlStateNormal];
    ...
    NSLog(@"incrementButton%@", NSStringFromCGRect(incrementButton.frame));
